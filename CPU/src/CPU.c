...
int aux_conec_ker=0;
  ...
  char* sentencia = malloc(1 * sizeof(char));
...
char* recibo= malloc(1*sizeof(char));
...
{
  /*int cant_caracteres;
   aca le envio mensaje al kernel
   */
}
...
prim_entradaSalida(t_nombre_dispositivo dispositivo, int tiempo)
{
  /*
   *
   * aca le mando el mensaje al kernel
   *
   */
